...
public class NpciInboundController {
    ...
    @PostMapping(value = "/ReqCredit", consumes = MediaType.APPLICATION_XML_VALUE, produces = MediaType.APPLICATION_XML_VALUE)
    public ResponseEntity<String> handleReqCredit(@RequestBody String xmlPayload) {
        return processRequest(xmlPayload, "ReqCredit");
    }
