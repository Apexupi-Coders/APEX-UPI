...
public interface WebhookConfigRepository extends JpaRepository<WebhookConfig, Long> {
     ...
     */
    Optional<WebhookConfig> findFirstByTpapIdIgnoreCaseAndEventType(String tpapId, EventType eventType);

    /**
     * Convenience alias used throughout the codebase and test fixtures.
     * Delegates to {@link #findByTpapIdIgnoreCaseAndEventType(String, EventType)}.
     * 
    ...
    default Optional<WebhookConfig> findActiveConfig(String tpapId, EventType eventType) {
        return findFirstByTpapIdIgnoreCaseAndEventType(tpapId, eventType);
    }
}
