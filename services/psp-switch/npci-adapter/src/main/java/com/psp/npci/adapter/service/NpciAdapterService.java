...
public class NpciAdapterService {
    ...
    public void handleBalance(NpciOutboundRequestEvent event) {
        ...
        log.info("[NPCI-ADAPTER] Calling NPCI BalanceEnquiry | url={} | txnId={}", url, txnId);
        ...
        try {
            ...
            log.error("[NPCI-ADAPTER] NPCI HTTP error on BalanceEnquiry | txnId={} | status={} | body={} | msg={}", 
                      txnId, ex.getStatusCode(), ex.getResponseBodyAsString(), ex.getMessage());
